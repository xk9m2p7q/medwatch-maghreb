...
export default async function handler(req, res) {
  ...
  let url = `${SUPABASE_URL}/rest/v1/items?select=id,title_en,title_es,summary_en,source_name,source_url,country,theme,signal,priority,priority_score,published_at`;
